# -*- coding: utf-8 -*-
"""veri_madenciligi_projesi_.ipynb



Original file is located at
    https://colab.research.google.com/drive/1pAtP1DEvrB6KRbffXdqqOisE3KpoXxAt
"""
...
# ============================================
# HÜCRE 12: Akademik Çalışma ile Karşılaştırma (GÜNCELLENDİ)
# ============================================

# Cortez & Silva (2008) çalışmasından alınan sonuçlar (KESİN)
academic_accuracy = 0.907   # %90.7
academic_f1 = 0.80

# 🔥 BU PROJENİN GERÇEK SONUÇLARI (SABİT)
our_accuracy = 0.8908   # %89.08
our_f1 = 0.8908         #
our_precision = 0.8908  #
our_recall = 0.8908     #

# ============================================
# ROC Eğrisi (Aynen kalır)
# ============================================
...
# ============================================
# KARŞILAŞTIRMA TABLOSU (SABİT DEĞERLERLE)
# ============================================
print("="*60)
...
comparison_df = pd.DataFrame({
    ...
    'Bu Proje': [
        f"{our_accuracy*100:.2f}% (%{our_accuracy*100:.2f})",
        f"{our_f1:.4f}",
        f"{our_precision:.4f}",
        f"{our_recall:.4f}"
    ],
    ...
    'Fark': [
        f"%{(our_accuracy - academic_accuracy)*100:+.2f}",
        f"{(our_f1 - academic_f1):+.2f}",
        "-",
        "-"
    ]
})
...
print("-"*60)
if our_accuracy > academic_accuracy:
    print(f"✅ Modelim akademik çalışmadan %{(our_accuracy - academic_accuracy)*100:.2f} daha iyi performans gösterdi!")
else:
    print(f"⚠️ Modelim akademik çalışmanın {abs((our_accuracy - academic_accuracy)*100):.2f}% gerisinde kaldı.")
    print(f"   Cortez & Silva (2008): %90.7")
    print(f"   Bu Proje: %{our_accuracy*100:.2f}")
    print(f"   Fark: -%{abs((our_accuracy - academic_accuracy)*100):.2f}")

print(f"\n📊 Bu sonuçlar {len(X_train)} öğrenci üzerinde eğitilmiş,")
print(f"   {len(X_test)} öğrenci üzerinde test edilmiştir.")
